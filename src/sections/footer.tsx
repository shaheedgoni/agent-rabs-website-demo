    ...
    <footer>
      <div className="footer-container">
        ...
        <div className="footer-group">
          <h3>Quick Links</h3>
          <a href="#hero">&bull; Home</a>
          <a href="#services">&bull; About Us</a>
          <a href="#services">&bull; Services</a>
          <a href="#whyus">&bull; Why Us</a>
          <a href="#testimonials">&bull; Testimonials</a>
        </div>

        <div className="footer-group">
          <h3>Contact</h3>
          <a>&bull; 123 Luxury Way, Kaduna, Nigeria</a>
          <a>&bull; +23480123456</a>
          <a>&bull; agentrabs123@gmail.com</a>
        </div>
        ...
        <div className="footer-right">
          <div className="email-fill">
            ...
            />
            <OrangeButton name="Subscribe" className="subscribe-footer" />
          </div>
      ...
      <div className="end-info">
        <p>© 2026 Agent Rabs & Partners. All rights reserved.</p>
      </div>
    </footer>
  );
}
